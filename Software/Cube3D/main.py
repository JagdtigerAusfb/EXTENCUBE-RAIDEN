...
class RubiksCube:
    ...
    def load_from_json(self):
        ...
        if os.path.exists("cube_state.json"):
            try:
...
def draw_axes_corner(rot_x, rot_y):
    ...
    l_off = s + 0.1 
    labels = [
        ("R (RIGHT)", (l_off, 0.0, 0.0)), ("F (FRONT)", (0.0, 0.0, l_off)), ("U (UP)", (0.0, l_off, 0.0)),
        ("L (LEFT)", (-l_off, 0.0, 0.0)), ("D (DOWN)", (0.0, -l_off, 0.0)), ("B (BACK)", (0.0, 0.0, -l_off))
    ]
